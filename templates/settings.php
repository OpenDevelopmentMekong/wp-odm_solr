<div class="wrap">
    ...
    <form method="post" action="options.php">
        ...
        <table class="form-table">
          <th scope="row"><label><h3><?php _e('Connecting to Solr','odi') ?></h3></label></th>
          <tr valign="top">
              <th scope="row"><label for="wp_odm_solr_setting_solr_host"><?php _e('Host','odi') ?></label></th>
              <td>
                ...
                <p class="description"><?php _e('Specify host without protocol, just domain. example: solr.opendevelopmentmekong.net ','odi') ?>.</p>
              </td>
          </tr>
          <tr valign="top">
              <th scope="row"><label for="wp_odm_solr_setting_solr_port"><?php _e('Port','odi') ?></label></th>
              <td>
                ...
                <p class="description"><?php _e('Specify the port under which the solr instance is available','odi') ?>.</p>
              </td>
          </tr>
          <tr valign="top">
              <th scope="row"><label for="wp_odm_solr_setting_solr_scheme"><?php _e('Scheme','odi') ?></label></th>
              <td>
                ...
                <p class="description"><?php _e('http or https','odi') ?>.</p>
              </td>
          </tr>
          <tr valign="top">
              <th scope="row"><label for="wp_odm_solr_setting_solr_path"><?php _e('Path','odi') ?></label></th>
              <td>
                ...
                <p class="description"><?php _e('Usually /solr/','odi') ?>.</p>
              </td>
          </tr>
          <tr valign="top">
              <th scope="row"><label for="wp_odm_solr_setting_solr_core_wp"><?php _e('Core WP','odi') ?></label></th>
              <td>
                ...
                <p class="description"><?php _e('Example: wordpress_content','odi') ?>.</p>
              </td>
          </tr>
          <tr valign="top">
              <th scope="row"><label for="wp_odm_solr_setting_solr_core"><?php _e('Core CKAN','odi') ?></label></th>
              <td>
                ...
                <p class="description"><?php _e('Example: collection1','odi') ?>.</p>
              </td>
          </tr>
          <tr valign="top">
              <th scope="row"><label for="wp_odm_solr_setting_solr_user"><?php _e('User','odi') ?></label></th>
              <td>
                ...
                <p class="description"><?php _e('Username for authentication','odi') ?>.</p>
              </td>
          </tr>
          <tr valign="top">
              <th scope="row"><label for="wp_odm_solr_setting_solr_pwd"><?php _e('Password','odi') ?></label></th>
              <td>
                ...
                <p class="description"><?php _e('Password for authentication','odi') ?>.</p>
              </td>
          </tr>
          <!-- Connection status -->
          <?php 
            ...
            <tr valign="top">
              ...
              <td>
                <?php if (WP_Odm_Solr_WP_Manager()->ping_server()){ ?>
                  <p class="ok"><?php _e('Ping to WP index succeded.','odi') ?></p>
                <?php } else { ?>
                  <p class="error"><?php _e('Problem connecting to WP index. Please, check the specified config.','odi') ?></p>
                <?php } ?>
                <?php if (WP_Odm_Solr_CKAN_Manager()->ping_server()){ ?>
                  <p class="ok"><?php _e('Ping to CKAN index succeded.','odi') ?></p>
                <?php } else { ?>
                  <p class="error"><?php _e('Problem connecting to CKAN index. Please, check the specified config.','odi') ?></p>
                <?php } ?>
              </td>
            </tr>          
          <?php 
